 ...
 *  for reverse driving.
 */
const uint8_t PROGMEM sineTable[SINE_TABLE_LENGTH * 3] = {
0,       0,      221,
8,       0,      225,
17,      0,      229,
25,      0,      232,
 ...
 */
const uint16_t PROGMEM divisionTable[256] = {
0,
 ...
 */
const uint8_t PROGMEM blockCommutationTableForward[16] =
{
  0,                          0,
  (1 << PB3),                 (1 << PD5),                 // UL, WH
  (1 << PB2),                 (1 << PD6),                 // UH, VL
 ...
 */
const uint8_t PROGMEM blockCommutationTableReverse[16] =
{
  0,  0,
  0x00,                       ((1 << PD6) | (1 << PD3)),  // UH, WL
  (1 << PB1),                 (1 << PD5),                 // UL, VH
 ...
 */
const uint8_t PROGMEM expectedHallSequenceForward[7] =
{
  0xff,    3,    6,    2,    5,    1,    4
};
 ...
 */
const uint8_t PROGMEM expectedHallSequenceReverse[7] =
{
  0xff,    5,    3,    1,    6,    4,    2
};
 ...
 */
const uint16_t PROGMEM CSOffsetsForward[8] =
{
  0,
 ...
 *  synchronize the generated sine waves to the back-EMF of the motor.
 */
const uint16_t PROGMEM CSOffsetsReverse[8] =
{
  0,
  1 * (SINE_TABLE_LENGTH / 6),
  5 * (SINE_TABLE_LENGTH / 6),
